...
function selectDomain(){
	...
	window.location.href="stat_domain_download.php?domain_id="+txtDoaminID+"&date2="+nDateSelect2;
}
...
function getDomainFlawData(domain_id,timeval)
{
	...
	var postUrl = "request_stat_data.php?mod=proxy&action=DownloadCount"+"&domain_id=" + domain_id +"&timeval="+timeval;
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				...
				<td height="31" width="85"><a href="stat_domain_download.php?domain_id=<?php echo $domain_id; ?>"><span class="title_bt">日流量统计</span></a></td>
...
getDomainFlawData(<?php echo $domain_id; ?>,30);
</script>
<?php
