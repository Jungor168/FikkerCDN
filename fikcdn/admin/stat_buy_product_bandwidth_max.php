...
function FikCdn_ExportExcel(buy_id,show_name){
	var date   =document.getElementById("BandwidthDateSelect2").value;
	
	var  getURL="./ajax_excel.php?mod=excel&action=buy_max"+"&date="+UrlEncode(date) +"&buy_id="+UrlEncode(buy_id)+"&show_name="+UrlEncode(show_name);
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				...
				<td height="31" width="85"><a href="stat_buy_product_bandwidth_max.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt">峰值带宽</span></a></td>
...
<?php
 ...
 ?>
	...
	<table width="800" border="0" class="bottom_btn">
			<tr height="30" bgcolor="#FFFFE6">
			<td>
			<span class="input_tips_txt3">每日最大带宽统计数据 - <?php echo $show_this_name; ?></span>
			<div class="div_search_title" style="padding-right:190px">选择日期：			
				...
				&nbsp;&nbsp;<input name="btnExportExcel"  type="submit" style="width:100px;height:24px" id="btnExportExcel" value="导出报表" style="cursor:pointer;" onClick="FikCdn_ExportExcel('<?php echo $buy_id; ?>','<?php echo $show_this_name; ?>');" />
			</div>
			</td>
			</tr>
		</table>
