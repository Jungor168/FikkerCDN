...
function FikCdn_ExportExcel(domain_id,show_name){
	var date   =document.getElementById("BandwidthDateSelect2").value;
	
	var  getURL="./ajax_excel.php?mod=excel&action=domain_max"+"&date="+UrlEncode(date) +"&domain_id="+UrlEncode(domain_id) +"&show_name="+UrlEncode(show_name);
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				...
				<td height="31" width="85"><a href="stat_domain_bandwidth_max.php?domain_id=<?php echo $domain_id; ?>"><span class="title_bt">峰值带宽</span></a></td>
 ...
 ?>
		...
		<table width="940" border="0" cellspacing="0" cellpadding="0" style="padding-left:45px">
			<tr>
				...
				<td class="title_line" width="18%" height="25" align="right" style="background-color: whitesmoke"><strong>7天内最大下载峰值带宽：</strong></td>
			...
			<tr>
				...
				<td class="title_line" width="18%" height="25" align="right" style="background-color: whitesmoke"><strong>7天内最大上传峰值带宽：</strong></td>
	...
	<table width="800" border="0" class="bottom_btn">
			<tr height="30" bgcolor="#FFFFE6">
			<td>
			<span class="input_tips_txt3">每日最大带宽统计数据 - <?php echo $this_hostname; ?></span>
			<div class="div_search_title" style="padding-right:135px">
			选择日期：			
				...
				&nbsp;&nbsp;<input name="btnExportExcel"  type="submit" style="width:100px;height:24px" id="btnExportExcel" value="导出报表" style="cursor:pointer;" onClick="FikCdn_ExportExcel('<?php echo $domain_id; ?>','<?php echo $this_hostname; ?>');" />
			</div>
			</td>
			</tr>
		</table>
						 
		<div id="div_search_result2" style="width:980px; padding-left:0px">
			<table width="950" border="0" class="dataintable" id="domain_table">
				<tr id="tr_domain_title">
					<th align="center" width="150">峰值带宽发生时间</th>
					<th align="right" width="120">当日下载峰值带宽</th>
					<th align="right" width="120">当时上传带宽</th>
					<th align="right" width="120">用户日下载流量</th>
					<th align="right" width="100" align="center">用户日上传流量</th>
					<th align="right" width="100" align="center">日请求量</th>
				</tr>	
<?php				
			if($db_link)
			{
...
?>								
	    ...
	    <table width="950" border="0" class="disc">
			<tr>
			<td width="110" align="right">平均下载带宽：</td><td width="105"><?php echo $arg_bandwidth_down; ?> Mbps</td>
			<td width="110" align="right">平均上传带宽：</td><td width="105"><?php echo $arg_bandwidth_up; ?> Mbps</td>
			<td width="120" align="right">日平均下载流量：</td><td width="105"><?php echo PubFunc_MBToString($arg_DownloadCount); ?></td>
			<td width="120" align="right">日平均上传流量：</td><td width="105"><?php echo PubFunc_MBToString($arg_UploadCount); ?></td>
			<td width="110" align="right">日平均请求量：</td><td width="105"><?php echo $arg_RequestCount; ?> 次</td>
			</tr>
		</table> 
		</div>					 				 
	  </td> 
