  ...
  <tr>
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
			<tr height="31">
				<td height="31" width="85"><span class="title_bt">密码修改</span></td>
				<td width="95%"></td>
			</tr>	
        </table>
	</td>
	  ...
	  <td valign="top">
		  <table width="800" border="0" class="dataintable">
			...
			<tr bgcolor="#FFFFFF" onMouseMove="Event_trOnMouseOver(this)" onMouseOut="Event_trOnMouseOut(this)">
				<td width="200" height="35" align="right"><span class="input_tips_txt3">原密码：</span></td>
				<td><input id="txtOldPasswd" name="txtOldPasswd" type="password" size="30" maxlength="32"  /> <span class="input_tips_txt" id="tipsOld" name="tipsOld" ></span> </td>
    		</tr>	
			<tr bgcolor="#FFFFFF" onMouseMove="Event_trOnMouseOver(this)" onMouseOut="Event_trOnMouseOut(this)">
				<td width="200" height="35" align="right"><span class="input_tips_txt3">新密码：</span></td>
				<td><input id="txtNewPasswd" name="txtNewPasswd" type="password" size="30" maxlength="32"  /> <span class="input_tips_txt" id="tipsNew" name="tipsNew" ></span>  </td>
    		</tr>	
			<tr bgcolor="#FFFFFF" onMouseMove="Event_trOnMouseOver(this)" onMouseOut="Event_trOnMouseOut(this)">
				<td width="200" height="35" align="right"><span class="input_tips_txt3">确认新密码：</span></td>
				<td><input id="txtAffirmPasswd" name="txtAffirmPasswd" type="password" size="30" maxlength="32"/>  <span class="input_tips_txt" id="tipsAffirm" name="tipsAffirm" ></span> </td>
    		</tr>	
			...
			<tr bgcolor="#FFFFFF" onMouseMove="Event_trOnMouseOver(this)" onMouseOut="Event_trOnMouseOut(this)">
				...
				<input name="btnReset"  id="btnReset" type="submit" style="width:90px;height:28px" value="重新输入" style="cursor:pointer;" onClick="FikCdn_ResetPasswd();" /> 
				</td>
    		</tr>
		 </table>
		 <p></p>
<?php
	/*		 
		 <table width="800" border="0" class="disc">
			<tr>
			<td bgcolor="#FFFFE6"><p>这里可以添加一些说明</p></td>
			</tr>
		</table>	
		*/
?>		
