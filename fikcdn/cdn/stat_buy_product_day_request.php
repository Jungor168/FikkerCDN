...
function getCrashReportStatData(buy_id,timeval)
{
	...
	var postUrl = "request_stat_data.php?mod=product&action=DayRequestCount&buy_id="+buy_id+"&timeval="+timeval;
...
function selectProduct()
{
	...
	window.location.href="stat_buy_product_day_request.php?buy_id="+buy_id+"&date2="+nDateSelect2;
}
    ...
    <td valign="top" background="../images/content-bg.gif">
	   <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2" >
			<tr height="31" class="TabToolTitle">
				...
				<td height="31" width="85"><a href="stat_buy_product_day_request.php?buy_id=<?php  echo $buy_id; ?>"><span class="title_bt">日请求量统计</span></a></td>					
